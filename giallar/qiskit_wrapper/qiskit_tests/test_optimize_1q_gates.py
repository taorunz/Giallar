...
from optimize_1q_gates_certiq import NewOptimize1QGate
...
class TestOptimize1qGates(QiskitTestCase):
    ...
    def test_optimize_h_gates_pass_manager(self):
        ...
        passmanager.append(NewOptimize1QGate())
...
#         simplified_dag = NewOptimize1QGate().run(dag)
...
#         self.assertEqual(num_u1_gates_remaining, 0)
    ...
    #     after = NewOptimize1QGate().run(dag)
...
# #    class TestNewOptimize1QGateBasis(QiskitTestCase):
# #    """Test for 1q gate optimizations parameter reduction with basis """
    ...
    def test_optimize_u3_basis_u3(self):
        ...
        passmanager = PassManager()
        passmanager.append(NewOptimize1QGate(['u3']))
        result = passmanager.run(circuit)
    ...
    def test_optimize_u3_basis_u2(self):
        ...
        passmanager = PassManager()
        passmanager.append(NewOptimize1QGate(['u2']))
        result = passmanager.run(circuit)
    ...
    def test_optimize_u3_basis_u2_cx(self):
        ...
        passmanager = PassManager()
        passmanager.append(NewOptimize1QGate(['u2', 'cx']))
        result = passmanager.run(circuit)
    ...
    def test_optimize_u1_basis_u2_u3(self):
        ...
        passmanager = PassManager()
        passmanager.append(NewOptimize1QGate(['u2', 'u3']))
        result = passmanager.run(circuit)
    ...
    def test_optimize_u3_basis_u2_u1(self):
        ...
        passmanager = PassManager()
        passmanager.append(NewOptimize1QGate(['u2', 'u1']))
        result = passmanager.run(circuit)
    ...
    def test_optimize_u3_basis_u1(self):
        ...
        passmanager = PassManager()
        passmanager.append(NewOptimize1QGate(['u1']))
        result = passmanager.run(circuit)
