...
from giallar.core.impl.qcircuit import empty_circuit, register_custom_definition, custom_definition
...
class UnrollCustomDefinitions(Transformation):

    def __init__(self, gate_name, gate_list):
        # super.__init__()
        self.name = gate_name
        self.list = gate_list
    ...
    def run(self, input_prop):
        ...
        for gate in qcirc.gate_list:
            ...
            if gate.name == self.name:
                
                gate_circ = custom_definition(gate)
